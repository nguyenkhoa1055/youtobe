...
<link rel="stylesheet" type="text/css" href="/PS24828_NguyenDangKhoa_ASM_Final/css/UserManager.css"><link>
		            ...
		            <div class="col-4 card">
		                <form action="${url}">
							...
							<div class="d-flex justify-content-end">
		                    	<button formaction="${url}/Update" class="btnbg btn btn-outline-dark m-3 px-2" type="submit"><i class="bi bi-person-up">Update</i></button>
		                    	<button formaction="${url}/Delete" class="btnbg btn btn-outline-dark m-3 px-2" type="submit"><i class="bi bi-person-dash">Delete</i></button>
		                	</div>
		                	<br>
		                			${message}
