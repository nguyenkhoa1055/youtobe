...
<link rel="stylesheet"
	href="/PS24828_NguyenDangKhoa_ASM_Final/css/login.css">
<link>
</head>
<body>
	<div class="container col-6">
        ...
        <mark>${message}</mark>
            <h2 class="mx-5 mt-2 mb-3" style="text-align: center;">Đăng Ký</h2>
            ...
            <p class="text-center">Already have an account? <a href="/PS24828_NguyenDangKhoa_ASM_Final/login">Sign in instead</a></p>
        </form>
    </div>
</body>
</html>