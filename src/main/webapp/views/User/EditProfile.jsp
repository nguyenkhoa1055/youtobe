...
<body>
	...
	<div class="container col-6">
		<form action="/PS24828_NguyenDangKhoa_ASM_Final/edit-profile" method="post" class="form rounded" style="border-radius:1px">
	        <h2 class="mx-5 mt-5" style="text-align: center;">Thông Tin Cá Nhân</h2>
