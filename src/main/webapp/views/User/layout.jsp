									...
									<div class="interact">
										...
										<button type="button" class="btn btn-outline-secondary">
											<a href="#" class="dropdown-item" data-bs-toggle="modal"
												data-bs-target="#myModal"> <i class="bi bi-share-fill">Share</i>
											</a>
										</button>
									</div>
								</div>
								...
								<div class="modal-body">
									<form action="" class="was-validated">
										...
										<div class="d-flex justify-content-end">
											<a
												onclick="event.preventDefault(); window.location.href='${url}?shareID=${item.id}'"
												class="btn btn-primary btnOK">OK</a>
										</div>
									</form>
								</div>
							</div>
